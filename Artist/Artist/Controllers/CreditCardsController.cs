...
namespace Artist.Controllers
{
    public class CreditCardsController : Controller
    {
        ...
        public CreditCardsController(ArtistContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CreditCardId,Code,Password,ExpireDate,TotalMoney")] CreditCard creditCard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CreditCardId,Code,Password,ExpireDate,TotalMoney")] CreditCard creditCard)
        {
